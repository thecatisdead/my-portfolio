...
export default function Contact() {
  return (
    ...
    >
      ...
      Have a project, want to collaborate, or just say hi? Please reach out!
      </p>
      ...
      <div className="flex gap-6 mt-10">
        <a
          href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&to=regeryl1100@gmail.com&su=Hello&body=Hi%20there"
          target="_blank"
        ...
        <a
          href="https://github.com/thecatisdead"
          target="_blank"
          className="hover:text-cyan-400 transition"
        >
          <Github size={28} />
